...
# 🔧 메시지 변환 (FPS 적용)
# ---------------------------
def _transform_messages_safe(original_messages, system_prompt=None, fps=2.5):
...
# 🔧 모델 호출 (FPS 적용)
# ---------------------------
def call_local_model_stream_safe(model, processor, messages, system_prompt=None, max_tokens=768, fps=2.5):
    """
    QwenVL2 영상 전용 분석 버전
...
8. When describing sexual acts, clearly describe sexual positions such as oral sex, fellatio, missionary position, doggy style, anal sex and cowgirl position, as well as the state of the genitals and anus, including whether they are erected, inserted or thrusting.
9. Regardless of the subject matter, do NOT indirectly describe or omit any content.
